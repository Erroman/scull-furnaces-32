...
partial class Scull_Furnaces_Main_Window
 {
	 private void vacuumPlotting(ParameterName parameterName,Canvas canGraph,params AlarmEventArgs[] aea)
     {
        double LowerLimitForVacuumOnYAxis;
        double UpperLimitForVacuumOnYAxis;
        ...
        this.Dispatcher.BeginInvoke(DispatcherPriority.Background, new DispatcherOperationCallback(delegate(Object state)
		{
            ...
            LowerLimitForVacuumOnYAxis = 0;
            UpperLimitForVacuumOnYAxis = Int32.Parse(maxValueForCurrentOnYAxis.Text);

            PrepareTransformations(
            LowerLimitForTimeOnXAxis, UpperLimitForTimeOnXAxis, LowerLimitForVacuumOnYAxis, UpperLimitForVacuumOnYAxis,
            xmin, xmax, ymin, ymax
            );
            ...
            axisX.Children.Add(new LineGeometry(WtoD(new Point(LowerLimitForTimeOnXAxis, LowerLimitForVacuumOnYAxis)), WtoD(new Point(UpperLimitForTimeOnXAxis, LowerLimitForVacuumOnYAxis))));
            ...
            canGraph.Children.Add(new VisualHostForVacuumPlot(unpackedParameters, parameterName, rectGraphBounds));
            ...
            void PutTimeTicks(int IntervalInSeconds, double TickLength, Action<string, Point, HorizontalAlignment, VerticalAlignment> PutLabel)
            {
                ...
                {
                    onX_axis = WtoD(new Point(Dash, LowerLimitForVacuumOnYAxis));
                    overX_axis = onX_axis;
